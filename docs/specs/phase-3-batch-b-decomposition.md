...
- Обновление `docs/phases/phase-3-checklist.md` — пункты по Батчу B.
...
**FILES_ALLOWED:** только docs/phases/phase-3-checklist.md, docs/knowledge/retros/phase_3_batch_b_notes.md (draft).
...
1. **Q9-уточнение — аудит bulk**: ✅ **одна запись** `audit_service.log()` на всю bulk-операцию с summary `{project_id, created, updated, total}`, НЕ построчно. Поэлементный diff before/after отменён. Зафиксировано в `docs/phases/phase-3-decisions.md` §Q9.
